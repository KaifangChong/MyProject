...
const getUserInfo = async () => {
  ...
  try {
    ...
    const res = await detailApi({ userId })
    tData.form = res.data
...
const validateForm = () => {
  ...
  if (!emailPattern.test(tData.form.email)) {
...
const submit = async () => {
  ...
  if (tData.form.avatarFile) formData.append('avatarFile', tData.form.avatarFile)
  if (tData.form.nickname) formData.append('nickname', tData.form.nickname)
  if (tData.form.email) formData.append('email', tData.form.email)
  if (tData.form.mobile) formData.append('mobile', tData.form.mobile)
  if (tData.form.description) formData.append('description', tData.form.description)
