    ...
    <div class="list-content">
      <div class="collect-video-view">
        <div class="video-list flex-view">
          <div class="video-item item-column-3" v-for="(item,index) in pageData.collectData" :key="index">
...
import {unCollectApi, userCollectListApi} from '/@/api/videoCollect'
...
const handleRemove = async (record) => {
  try {
    await unCollectApi({ id: record.id })
