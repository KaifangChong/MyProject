  ...
  <div>
    ...
    <div class="page-view">
      ...
      >
        ...
        <a-table-column title="IP地址" dataIndex="ip" key="ip" align="center" />
        <a-table-column title="User-Agent" dataIndex="ua" key="ua" align="center" />
        <a-table-column title="登录时间" dataIndex="time" key="time" align="center" />
      </a-table>
    </div>
  </div>
</template>
