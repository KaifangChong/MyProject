  ...
  <div>
    ...
    <div class="page-view">
      ...
      >
        ...
        <a-table-column title="标题" dataIndex="title" key="title" align="center" />
        <a-table-column title="内容" dataIndex="content" key="content" align="center">
          <template #default="{ text }">{{ text?.substring(0, 20) }}...</template>
        </a-table-column>
